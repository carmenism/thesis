...
In order for users to understand and compare decisions, the ability to perceive changes in biomass resulting from changes in the fishing effort is necessary.  Therefore, we have introduced three alternatives to displaying these changes.  The first is to simply have the biomass plots change instantaneously as the harvest effort sliders are adjusted.  The second is a dotted line which shows the previously projected biomass compared with the currently projected biomass.  The third is a blend of color originating from the current biomass projection that diminishes in opacity as it approaches the previously projected biomass.
