...
\begin{figure}
	\centering
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth]{figures/ratioBad.eps}
		\caption{Shape parameter of 1.0.}
		\label{fig:ratioBad}
	\end{subfigure}	
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth]{figures/ratioGood.eps}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=8cm]{figures/gaichas.eps}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=8cm]{figures/matrix.eps}
