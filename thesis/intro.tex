...
\subfigure[Spiral time series.  Reprinted from \textit{IEEE Symposium on Information Visualization}, \citeauthor{weber2001}, Visualizing time-series on spirals, 7--13, \textcopyright \citeyear{weber2001}, with permission from IEEE.]{\label{fig:altSpiral}\includegraphics[width=0.45\textwidth]{figures/png/spiral.png}} 
...
%\begin{figure}[h]
%	\centering
%	\includegraphics[width=8cm]{figures/png/force.png}
...
\subfigure[A screenshot of VisiCalc.  GNU General Public License.]{\label{fig:visicalc}\includegraphics[height=4cm]{figures/png/visicalc.png}} 
