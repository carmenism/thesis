...
\begin{figure}
	...
	\end{subfigure}
	\caption[Four possible methods for visualizing multiple time series.]{Four possible methods for visualizing multiple time series.  Reprinted from ``Graphical perception of multiple time series'' by \citeauthor{javed2010} with permission.  \textcopyright  \citeyear{javed2010} IEEE.}% \cite{javed2010}.}
...
\caption[Spiral time series.]{Spiral time series.  Reprinted from ``Visualizing time-series on spirals'' by \citeauthor{weber2001} with permission.  \textcopyright  \citeyear{weber2001} IEEE.}
...
\caption[ThemeRiver time series.]{ThemeRiver time series.  Reprinted from ``ThemeRiver: visualizing theme changes over time'' by \citeauthor{havre2000} with permission.  \textcopyright  \citeyear{havre2000} IEEE.}
...
\caption[Three metaphors for conveying causality.]{Three metaphors for conveying causality.  Reprinted from ``Visualizing causal relations'' by \citeauthor{ware1999} with permission.  \textcopyright  \citeyear{ware1999} IEEE.}
...
\caption[Two alternatives for visualizing causal influences.]{Two alternatives for visualizing causal influences.  Reprinted from ``Visualizing causal semantics using animations'' by \citeauthor{kadaba2007} with permission.  \textcopyright  \citeyear{kadaba2007} IEEE.}
...
\centering
	\begin{subfigure}[b]{0.4\textwidth}
		...
		\caption[A screenshot of VisiCalc.]{A screenshot of VisiCalc.  GNU General Public License.}
		\label{fig:visicalc}
	\end{subfigure}	
	\begin{subfigure}[b]{0.4\textwidth}
		\centering
		\includegraphics[height=4cm]{figures/eps/excel.eps}
		\caption[A chart made using Microsoft Excel.]{A chart made using Microsoft Excel.  Public domain.}
		\label{fig:excel}
	\end{subfigure}
