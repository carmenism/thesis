...
To accomplish this goal, we determined the visualization of the MS-PROD model would need to convey:

\begin{itemize}
	\item The predicted biomass over time,
	\item Changes in predicted biomass as a result of changes in fishing effort,
	\item Relationships between the species (i.e., causal effects in the model), and
