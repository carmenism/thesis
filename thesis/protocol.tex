{\setlength{\parskip}{10pt plus 1pt minus 1pt} {\setlength{\parindent}{0cm}
...
[\underline{\textit{Condition B ends here; resume at \textbf{Training Example}}}]
\end{minipage}
}
...
\fbox{%
  \begin{minipage}{\textwidth}
[\underline{\textit{Condition C and D continue}}]
